	...
	<v-container>
		<v-layout row wrap>
			<v-flex xs12>
				...
				<p>
					Данный проект создан для всестороннего исследования <router-link to="/revolution">актуальности</router-link>
				...
				<p>Всем желающим предлагается принять участие в этом исследовании.
				Проясним вопрос коллективным разумом!</p>
